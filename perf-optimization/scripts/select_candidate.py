#!/usr/bin/env python3
"""Backward-compatible wrapper for select_candidate.

Canonical code lives in scripts/perf_benchmark/select_candidate.py.
Kept for one migration release; new callers should use the canonical path
or the `perf-select-candidate` console script.
"""
